  ...
  methods: { ...Object(external_vuex_["mapMutations"])(['setUser']),
    ...
    async handlerLogin() {
      try {
        let {
          data
        } = await (this.isLogin ? login : register)({
          user: this.user
        });
        this.setUser(data.user);
        external_js_cookie_default.a.set("user", data.user);
      } catch (error) {
